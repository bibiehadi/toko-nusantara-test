...
class UserController extends Controller
{
    ...
    {
         $va    lidatedData = $request->validate([
        ...
        if(User::create($validatedData)){
            ...
            return redirect('/dashboard/users')->with('error','Failed add user data!!');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(HargaBarang::where('id', $validatedData['id'])->update($validatedData)){
